...
function Library:CreateUI(uiname,scrollenabled,elementspacing,framesize,TextAllignment)
  ...
  function UIElements:Button(buttonname,buttoninfo,callback)
  ...
  function UIElements:Toggle(togglename,toggleinfo,callback)
  ...
  function UIElements:Slider(slidername,minvalue,maxvalue,callback)
...
releaseconnection = nil
  ...
  function UIElements:TextBox(textboxname,textboxinfo,defaulttext,callback)
  ...
  function UIElements:Dropdown(dropdownname,list,callback)
    ...
    for i,v in pairs(list) do
      ...
      Option.MouseButton1Down:Connect(function()
        ButtonNow("确定选择值", "当前选择:"..v, "确认选择", "点错了", 5, function(text)
          if text == "确认选择" then
            DropdownEnabled = false
            DropdownFalse.Visible = true
            DropdownTrue.Visible = false
  ...
  function UIElements:Text(labelname,labelinfo)
  ...
  function UIElements:ButtonNow(a,b,c,d,e,f,j)
    ButtonNow(a, b, c, d, e, function(o)
      if o == c then
        f()
       elseif o == d then
        j()
